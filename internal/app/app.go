...
import (
	...
	"github.com/agriardyan/extend-game-telemetry-collector/internal/bootstrap"
	"github.com/agriardyan/extend-game-telemetry-collector/internal/server"
...
func (app *Application) Run(ctx context.Context) error {
	...
	if err := server.StartGRPCGateway(ctx, server.GatewayConfig{
		Port:       server.GRPCGatewayHTTPPort,
		GRPCAddr:   fmt.Sprintf("localhost:%d", server.GRPCServerPort),
		BasePath:   basePath,
